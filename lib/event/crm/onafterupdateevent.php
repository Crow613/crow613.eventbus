...
final class OnAfterUpdateEvent extends \Crow613\EventBus\Event\RegisterEvents
{
    ...
    {
        self::handlerRegister(self::AFTER_CRM_LEAD_UPDATE, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::AFTER_CRM_DEAL_UPDATE, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::AFTER_CRM_CONTACT_UPDATE, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::AFTER_CRM_COMPANY_UPDATE, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::AFTER_CRM_ACTIVITY_UPDATE, $class, $handler);
    }
