...
final class OnBeforeDeleteEvent extends \Crow613\EventBus\Event\RegisterEvents
{
    ...
    {
        self::handlerRegister(self::BEFORE_CRM_LEAD_DELETE, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::BEFORE_CRM_DEAL_DELETE, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::BEFORE_CRM_CONTACT_DELETE, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::BEFORE_CRM_COMPANY_DELETE, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::BEFORE_CRM_ACTIVITY_DELETE, $class, $handler);
    }
