<?php
namespace Crow613\EventBus\Event\Rest;
...
final class OnAfterAddEvent extends \Crow613\EventBus\Event\RegisterEvents
{
    ...
    {
        self::handlerRegister(self::AFTER_CRM_LEAD_ADD, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::AFTER_CRM_DEAL_ADD, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::AFTER_CRM_CONTACT_ADD, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::AFTER_CRM_COMPANY_ADD, $class, $handler);
    }
    ...
    {
        self::handlerRegister(self::AFTER_CRM_ACTIVITY_ADD, $class, $handler);
    }
